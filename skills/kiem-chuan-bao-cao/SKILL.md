...
description: "Đối chiếu bản thảo với chuẩn báo cáo hợp thiết kế như CONSORT, STROBE, PRISMA, theo đúng từng mục của bản chính thức. Checks reporting-guideline compliance item by item."
metadata:
