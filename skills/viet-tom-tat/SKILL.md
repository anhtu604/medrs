...
Return lifecycle state, manuscript hash, consistency matrix, numeric provenance, novelty record/marker, conflicts, draft, preflight, gate state, and submission verdict.
