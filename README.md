...
Start with `skills/co-van/SKILL.md`. Non-Claude agents can enumerate the present skills from the generated `skills/index.json`.
...
```powershell
.\install.ps1 -Targets codex,claude,generic
.\doctor.ps1 -Targets codex,claude,generic
```
